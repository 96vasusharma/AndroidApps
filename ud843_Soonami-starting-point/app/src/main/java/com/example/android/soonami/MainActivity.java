    ...
    private class TsunamiAsyncTask extends AsyncTask<URL, Void, Event> {
        ...
        private String makeHttpRequest(URL url) throws IOException {
            ...
            try {
                ...
                if(urlConnection.getResponseCode() == 200){   //200 for successful connection
                    // 400 for client side problems like 404 for page not found
        ...
        private Event extractFeatureFromJson(String earthquakeJSON) {
            //if json is empty string we return early
            if(TextUtils.isEmpty(earthquakeJSON)){  // just like checking string is null
                return null;
            }
            try {
